...
import { QUARTZ } from '../data';

// Scoped to this repository only: the live release history is read straight from
// the GitHub Releases API for malcolmston/quartz.
const RELEASE_LIBS: RelLib[] = [
  { name: QUARTZ.name, icon: QUARTZ.icon, accent: QUARTZ.accent, repo: ghrepo(QUARTZ), url: QUARTZ.repo },
];
